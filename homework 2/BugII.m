function BugII(serPort)
    ...
    while 1
        ...
        while ((~IsEquivalent(currentX, 0) || ~IsEquivalent(currentY,4)) && (~IsEquivalent(currentX, 0) || ~IsEquivalent(currentY, lastY)) ...
            && (~IsEquivalent(currentX, 0) || lastY - currentY > 0.1))

            [currentX,currentY, angle] = followTheBoud(serPort, currentX, currentY, angle)
...
function [currentX, currentY, angle] = followTheBoud(serPort, startX, startY, startAngle)
   max_vel = 0.4;
